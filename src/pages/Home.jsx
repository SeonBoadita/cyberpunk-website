        ...
        <>
            ...
            <div className="main-cont relative w-full h-full">
                <div className="mask-image-section fixed top-0 left-0 w-full h-screen z-99 pointer-events-none">
                    <div className="mask-image-container absolute bottom-[-5vh] left-[55%] w-[45vw] h-[90vh] transform -translate-x-1/2 z-70">
                    ...
                    <div id="smooth-content" className="smooth-content-class">
                        ...
                        >
                            <div
                                ...
                                transparent 0px,
                                transparent 100px,
                                rgba(0, 0, 0, 0.5) 400px,
                                rgba(0, 0, 0, 0.7) 600px,
                                rgba(0, 0, 0, 0.9) 700px,
                                rgba(0, 0, 0, 0.95) 800px,
                                rgba(0, 0, 0, 1) 1000px
                                )`,
                            ...
                            <div className="section-2-container relative top-0 left-0 w-full h-[105vh]">
                                <div className="section-two-cont relative top-0 left-0 w-full h-full rounded-t-4xl  border-t-[1.5vh] border-[#ef26e9] bg-[#0a060d] z-1">
